...
The [`question`](https://github.com/PeruibeTec/Server-v2/labels/question%20or%20discussion) labels are a good place to find ongoing discussions.

### Code

You can use issue labels to discover issues you could help out with:

- [`bug` issues](https://github.com/PeruibeTec/Server-v2/labels/bug)
  are known bugs we'd like to fix;
- [`feature request` issues](https://github.com/PeruibeTec/Server-v2/labels/feature%20request)
